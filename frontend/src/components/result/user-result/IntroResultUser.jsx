        ...
        <section className='intro-result-user'>
            <div className="winner-case p-4 h-100 text-center">
                        ...
                        <p className="winner-text">
                            Il s'agit ce mois ci de {winner.username} qui est le seul a avoir trouvé le 5 ou qui est celui qui a  été le plus près des statistiques de chaque joueur !
                            Voici donc ci-dessous ton Top 5, le Top 5 de référence ainsi que le Top 5 gagnant mis côte à côte afin de pouvoir mieux les comparer.
                        </p>
...
export default IntroResultUser
