        ...
        <section className='intro-result-user'>
            <div className="winner-case p-4 h-100 text-center">
                        ...
                        <p className="winner-text">
                            ...
                            Voici donc ci-dessous le Top 5 de référence ainsi que le Top 5 gagnant mis côte à côte afin de pouvoir mieux les comparer.
                        </p>
...
export default IntroResultVisitor;
